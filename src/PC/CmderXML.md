...
<key name="Software">
    <key name="ConEmu">
        <key name=".Vanilla" modified="2019-05-15 14:29:02" build="180626">
            ...
            <value name="ConWnd X" type="long" data="527"/>
            <value name="ConWnd Y" type="long" data="235"/>
            ...
            <key name="Tasks" modified="2019-03-04 14:18:31" build="180626">
                ...
                <key name="Task2" modified="2019-05-15 14:32:06" build="180626">
                    <value name="Name" type="string" data="{cmd::Cmder}"/>
                    <value name="GuiArgs" type="string" data=' /icon "%CMDER_ROOT%\icons\cmder.ico"'/>
                    <value name="Cmd1" type="string" data='cmd /k ""%ConEmuDir%\..\init.bat"  -new_console:d:C:\ "'/>
                    <value name="Active" type="long" data="0"/>
                    <value name="Count" type="long" data="1"/>
                    <value name="Hotkey" type="dword" data="00000000"/>
                    <value name="Flags" type="dword" data="00000000"/>
                ...
                <key name="Task6" modified="2019-03-04 14:20:35" build="180626">
                    <value name="Name" type="string" data="{Inicio}"/>
                    <value name="Flags" type="dword" data="00000004"/>
                    <value name="Hotkey" type="dword" data="00000000"/>
                    <value name="GuiArgs" type="string" data='/dir "C:\"'/>
                    <value name="Cmd1" type="string" data='*"%ConEmuDir%\..\git-for-windows\usr\bin\mintty.exe" /bin/bash -l'/>
                    <value name="Active" type="long" data="0"/>
                    <value name="Count" type="long" data="1"/>
                    <value name="Cmd2" type="string" data='"%CMDER_ROOT%vendor\git-for-windows\usr\bin\mintty.exe" /bin/bash -l'/>
                </key>
                <key name="Task7" modified="2019-03-04 14:18:31" build="180626">
                ...
                <key name="Task8" modified="2019-03-04 14:18:31" build="180626">
                ...
                <key name="Task9" modified="2019-03-04 14:18:31" build="180626">
                ...
                <key name="Task10" modified="2019-03-04 14:18:31" build="180626">
            ...
            <key name="HotKeys" modified="2019-03-04 14:14:08" build="180626">
                <value name="KeyMacroVersion" type="hex" data="02"/>
                <value name="Multi.Modifier" type="dword" data="00000011"/>
                <value name="Multi.ArrowsModifier" type="dword" data="0000005b"/>
                <value name="MinimizeRestore" type="dword" data="000011c0"/>
            ...
            <value name="LastMonitor" type="string" data="0,0,1920,1036"/>
